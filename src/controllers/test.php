<?php
/*session_start();*/
$id = mysqli_connect("localhost","root","","captech");
if(isset($_POST["bout"])){
    $mail = $_POST["mail"];
    $mdp = $_POST["mdp"];
    ...
    if(mysqli_num_rows($res) > 0){
        ...
        $erreur = "Erreur de mot de passe ou de login !!!";
    ...
    if ($email === 'admin@gmail.com' && $password === 'admin123') {
        ...
        header('Location: Acceuil.php'); // Redirection vers le tableau de bord de l'administrateur
        exit;
    } else {
        // Identifiants incorrects pour l'administrateur
        header('Location: connection.php'); // Redirection avec indication d'erreur
        exit;}
}
?>
        ...
        <div class="content">
            <section class="section hero">
                <form action="" method="post">
                    ...
                    <input type="email" id="username" name="mail" placeholder="Entrez votre mail" required >
                    ...
                    <label id="showPasswordToggle" for="showPasswordCheck">
                        <input type="checkbox" class="show"  id="showPasswordCheck">Show
                    <input type="submit" class="submit" value="Se connecter" name="bout"><br><br>
                </form>
                <div class="inscrip">
                <p class="inscrip"> Pas encore inscrit ? Cliquez <a href="inscription_page.php">ICI</a> </p>
