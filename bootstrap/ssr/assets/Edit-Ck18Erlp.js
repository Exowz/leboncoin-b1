import { useSSRContext, mergeProps, onMounted, onUnmounted, computed, ref, unref, withCtx, renderSlot, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, withModifiers } from "vue";
...
import _sfc_main$9 from "./DeleteUserForm-DFRCl3Sh.js";
import _sfc_main$8 from "./UpdatePasswordForm-oCL4HP0Z.js";
import _sfc_main$7 from "./UpdateProfileInformationForm-D9fGcEqk.js";
import "./TextInput-Bq3bXff-.js";
import "./PrimaryButton-C_rIuqoS.js";
const _sfc_main$6 = {};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<form${ssrRenderAttr("action", _ctx.route("logout"))} method="post" class="hidden"${_scopeId}> @csrf </form>`);
          } else {
            return [
      ...
      _push(`<form${ssrRenderAttr("action", _ctx.route("logout"))} method="post" class="hidden"> @csrf </form></div></div></div></nav>`);
